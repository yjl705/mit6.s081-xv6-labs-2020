...
void            kvminit(void);
void            kvm_map_pagetable(pagetable_t ptb);
void            kvminithart(void);
uint64          kvmpa(pagetable_t ptb, uint64);
void            kvmmap(pagetable_t ptb, uint64, uint64, uint64, int);
void            kvm_free_kernelpgtbl(pagetable_t ptb);
